...
const MsgCreateSession = {
	encode(message, writer = new _bufbuild_protobuf_wire.BinaryWriter()) {
		...
		if (message.session_key !== void 0) require_any.Any.encode(message.session_key, writer.uint32(18).fork()).join();
	...
	decode(input, length) {
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				...
				case 2:
					if (tag !== 18) break;
					message.session_key = require_any.Any.decode(reader, reader.uint32());
					continue;
				case 3:
					if (tag !== 24) break;
	...
	fromJSON(object) {
		return {
			...
			session_key: isSet(object.session_key) ? require_any.Any.fromJSON(object.session_key) : void 0,
	...
	toJSON(message) {
		...
		if (message.session_key !== void 0) obj.session_key = require_any.Any.toJSON(message.session_key);
	...
	fromPartial(object) {
		...
		message.session_key = object.session_key !== void 0 && object.session_key !== null ? require_any.Any.fromPartial(object.session_key) : void 0;
...
//#endregion
exports.MsgCreateSession = MsgCreateSession;
exports.MsgRevokeAllSessions = MsgRevokeAllSessions;
exports.MsgRevokeSession = MsgRevokeSession;
