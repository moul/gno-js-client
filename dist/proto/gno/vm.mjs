...
const MemPackage = {
	encode(message, writer = new BinaryWriter()) {
		...
		if (message.type !== void 0) Any.encode(message.type, writer.uint32(34).fork()).join();
		if (message.info !== void 0) Any.encode(message.info, writer.uint32(42).fork()).join();
		return writer;
	},
	decode(input, length) {
		const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
	...
	fromJSON(object) {
		return {
			...
			type: isSet(object.type) ? Any.fromJSON(object.type) : void 0,
			info: isSet(object.info) ? Any.fromJSON(object.info) : void 0
		};
	},
	toJSON(message) {
		const obj = {};
		...
		if (message.type !== void 0) obj.type = Any.toJSON(message.type);
		if (message.info !== void 0) obj.info = Any.toJSON(message.info);
		return obj;
	},
	create(base) {
	...
	fromPartial(object) {
		...
		message.type = object.type !== void 0 && object.type !== null ? Any.fromPartial(object.type) : void 0;
		message.info = object.info !== void 0 && object.info !== null ? Any.fromPartial(object.info) : void 0;
		return message;
	}
};
