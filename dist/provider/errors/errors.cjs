...
* trace) for debugging.
*/
var GnoABCIError = class extends _gnolang_tm2_js_client.TM2Error {
...
var TypeCheckError = class extends GnoABCIError {
	constructor(errors = [], message, log) {
		...
		require_defineProperty._defineProperty(this, "errors", void 0);
		this.errors = errors;
	}
};
...
const constructGnoError = (error, log) => {
	const raw = error;
	const type = String(raw[_gnolang_tm2_js_client.ABCIErrorKey] ?? "");
...
//#endregion
exports.GnoABCIError = GnoABCIError;
exports.GnoErrorType = GnoErrorType;
exports.InvalidExprError = InvalidExprError;
exports.InvalidFileError = InvalidFileError;
exports.InvalidPackageError = InvalidPackageError;
exports.InvalidPkgPathError = InvalidPkgPathError;
exports.InvalidStmtError = InvalidStmtError;
exports.NoRenderDeclError = NoRenderDeclError;
exports.ObjectNotFoundError = ObjectNotFoundError;
exports.PkgExistError = PkgExistError;
exports.StringError = StringError;
exports.TypeCheckError = TypeCheckError;
exports.UnauthorizedUserError = UnauthorizedUserError;
exports.assertNoABCIError = assertNoABCIError;
exports.constructGnoError = constructGnoError;
exports.parseABCIErrorLog = parseABCIErrorLog;
